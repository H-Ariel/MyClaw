...
public:
	...
	static shared_ptr<WapWwd> loadLevelWwdFile(int levelNumber); // load the level WWD file and initialize more assets
	static shared_ptr<WapPal> loadPidPalette(const string& palPath); // load the palette and set it to the images manager
	...
	static void setBackgroundMusic(BackgroundMusicType type);
