...
//	if (levelNumber == 3) _player->position = { 11054, 8720 };
	if (levelNumber == 4) _player->position = { 3127, 5024 };
...
//	if (levelNumber == 5) _player->position = { 19041, 4511 };
...
//	if (levelNumber == 7) _player->position = { 15419, 7388 };
	if (levelNumber == 7) _player->position = { 25856, 6876 };
//	if (levelNumber == 7) _player->position = { 25210, 7196 };
//	if (levelNumber == 8) _player->position = { 4466, 5039 };
	if (levelNumber == 8) _player->position = { 6160, 5232 };
...
//	if (levelNumber == 10) _player->position = { 32368, 7769 }; // END OF LEVEL
	if (levelNumber == 10) _player->position = { 40504, 7246 }; // boss
